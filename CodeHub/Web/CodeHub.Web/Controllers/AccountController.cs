namespace CodeHub.Web.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        public AccountController(ICodeHubData data, IFileUploader fileUploader) : base(data)
        {
            this.fileUploader = fileUploader;
        }

        public AccountController(ApplicationUserManager userManager, ApplicationSignInManager signInManager, ICodeHubData data, IFileUploader fileUploader) : this(data, fileUploader)
        {
